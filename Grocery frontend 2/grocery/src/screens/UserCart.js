...
//             // Fetch admin details for the product
...
//     const orderDetails = {
//       customerId,
//       products: products.map(product => ({ productId: product._id, quantity: product.quantity })), // Send only necessary details
//       adminId,
//       totalPrice
//     };
...
//       setCartProducts(cartProducts.filter(product => product.adminId !== adminId)); // Remove products from the cart after successful checkout
//     } catch (error) {
...
//       <div className="cart-page">
        ...
        //         <div>Total: ${products.reduce((total, product) => total + product.price, 0)}</div>
...
//   const [quantityCount, setQuantityCount] = useState({}); // Maintain count for each product
...
//         // Initialize quantity count for each product to 1
...
//         quantity: quantityCount[product._id], // Use quantity count
...
//       toast.success('Order placed successfully!');
//       setCartProducts(prevProducts => prevProducts.filter(product => product.adminId !== adminId)); // Remove products from the cart after successful checkout
//       setBillDetails({ adminId, storeName: products[0].storeName, totalPrice });
//       setShowBill(true);
//     } catch (error) {
//       console.error('Error creating order:', error);
//       toast.error('Failed to place order');
...
//                         <button onClick={() => updateQuantity(product._id, -1)}><FaMinus /></button>
//                         <span>{quantityCount[product._id]}</span>
//                         <button onClick={() => updateQuantity(product._id, 1)}><FaPlus /></button>
//                         </div>
//                       <h4>Price: ${product.price}</h4>
//                       <h4>Description: {product.description}</h4>
//                       <div className="buttons">
...
//           <ReactToPrint
//             trigger={() => <button onClick={printBill}>Print Bill</button>}
...
//               <p>Total Price: ${billDetails.totalPrice}</p>
//             </div>
//           </div>
...
//       toast.success('Order placed successfully!');
//       setCartProducts(prevProducts => prevProducts.filter(product => product.adminId !== adminId)); // Remove products from the cart after successful checkout
//       setBillDetails({ adminId, storeName: products[0].storeName, totalPrice, products }); // Include products in billDetails
//       setShowBill(true);
//     } catch (error) {
//       console.error('Error creating order:', error);
//       toast.error('Failed to place order');
...
//                         <button onClick={() => updateQuantity(product._id, 1)}><FaPlus /></button>
//                       </div>
//                       <h4>Quantity: {quantityCount[product._id]}</h4> {/* Display quantity here */}
//                       <h4>Price: ${product.price}</h4>
//                       <h4>Description: {product.description}</h4>
//                       <div className="buttons">
//                         <button className='remove-btn' onClick={() => removeFromCart(product._id)}><FaTrash className="remove-icon" /> Remove</button>
